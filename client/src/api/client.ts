...
export const mapsApi = {
  ...
  details: (placeId: string, lang?: string, expand?: boolean) => apiClient.get(`/maps/details/${encodeURIComponent(placeId)}`, { params: { lang, expand: expand ? '1' : undefined } }).then(r => r.data),
